  ...
  d3.json(stateInfo, stateData => {
    ...
    console.log(city_data);
      ...
      function onEachFeature(feature, layer) {
        ...
        layer.bindPopup('<h2>' + properTitle + '</h2><hr><h3>Number of ' 
        + properJobChoice + ' jobs: ' + feature.properties[jobChoice].number_jobs + '<br>'
        + 'Average Salary: $'+ (feature.properties[jobChoice].avg_salary).toFixed(2).replace(/\d(?=(\d{3})+\.)/g, '$&,')  + '</h3>'   );
